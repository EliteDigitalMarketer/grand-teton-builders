...
export const metadata: Metadata = {
  ...
  description: 'Contact Grand Teton Builders to inquire about new construction homes in Driggs, Idaho, custom builds in Teton Valley, or upcoming spec homes.',
      ...
      <main style={{ paddingTop: 116 }}>
        <section className="contact" style={{ padding: '96px 5vw' }}>
          ...
          <p className="section-sub">
            Interested in the Driggs home, a custom build, or a future project in Teton Valley?
