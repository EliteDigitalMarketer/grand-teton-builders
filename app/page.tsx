  ...
  return (
    <>
      ...
      <div className="trust-bar" role="complementary" aria-label="Builder highlights">
        ...
        <div className="trust-item">
          <div>
            <div className="trust-num">10yr</div>
            <div className="trust-label">Structural warranty</div>
          </div>
        </div>
        <div className="trust-divider" aria-hidden="true" />
        <div className="trust-item">
      ...
      <section className="featured-home" aria-labelledby="featured-home-heading">
        ...
        <p className="section-sub">
          ...
          Teton Valley. Follow the build and inquire about availability.
        </p>
        <div className="featured-home-card">
          ...
          <div className="featured-home-info">
            ...
            <div className="featured-home-specs">
              <div>
                <div className="spec-val">[TBD]</div>
          ...
          <article className="service-card" role="listitem">
            ...
            <div className="service-card-body">
              ...
              <p className="service-desc">
                ...
                specifications in Driggs, Idaho &mdash; and priced to move when
                the time is right.
              </p>
            </div>
          </article>
      ...
      <section className="process" aria-labelledby="process-heading">
        ...
        <div className="process-steps" role="list">
          ...
          <div className="step" role="listitem">
            ...
            <p className="step-desc">
              Final walkthrough, punch list, and keys in hand. Your structural
              warranty starts on day one.
            </p>
          </div>
        </div>
          ...
          <div className="contact-info">
            ...
            <div className="contact-item">
              ...
              <div>
                ...
                <div className="contact-item-val">[Phone — Add Here]</div>
              </div>
            </div>
            <div className="contact-item">
              <div className="contact-item-icon" aria-hidden="true">&#x2709;</div>
              <div>
                ...
                <div className="contact-item-val">[Email — Add Here]</div>
              </div>
            </div>
